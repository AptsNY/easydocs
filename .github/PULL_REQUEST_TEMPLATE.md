...
- [ ] **Every commit is signed off** — `git commit -s`. A CI job (`dco-check`) rejects any commit
      ...
      [DCO](https://github.com/Robertzu43/easydocs/blob/main/CONTRIBUTING.md#developer-certificate-of-origin-dco),
...
- [ ] I read [CONTRIBUTING.md](https://github.com/Robertzu43/easydocs/blob/main/CONTRIBUTING.md) and
      agree to the
      [Code of Conduct](https://github.com/Robertzu43/easydocs/blob/main/CODE_OF_CONDUCT.md).
...
- [ ] This PR changes a **security property** listed in
      [SECURITY.md](https://github.com/Robertzu43/easydocs/blob/main/SECURITY.md#what-is-hardened).
      <!-- Say which, and why. -->
- [ ] None of the above.
